    ...
    fn apply_legality_report(
        ...
        for diagnostic in report.diagnostics {
            ...
            match diagnostic.severity {
                mercurio_runtime::RuleDiagnosticSeverity::Error => blocking_reasons.push(issue),
                mercurio_runtime::RuleDiagnosticSeverity::Warning
                | mercurio_runtime::RuleDiagnosticSeverity::Info => warnings.push(issue),
            }
        }
    }
}
...
"#
    ...
    fn relationship_candidate_is_semantically_checked_and_writable() {
        ...
        let mut project = context.project.clone();
        let result = project
            .apply_mutation(mercurio_authoring::authoring::Mutation::AddRelationship {
                container: mercurio_authoring::authoring::ContainerSelector::Declaration {
...
"#
        ...
        let mut project = context.project.clone();
        let result = project
            .apply_mutation(mercurio_authoring::authoring::Mutation::SetExpression {
