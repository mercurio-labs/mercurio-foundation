...
use mercurio_semantic_services::feasibility::{FeasibilityStatus, MutationFeasibilityReport};
use mercurio_semantic_services::mutation::MutationProposal;
...
mod tests {
    ...
    use mercurio_semantic_services::mutation::{MutationProposal, SemanticDiff, WorkspaceRevision};
