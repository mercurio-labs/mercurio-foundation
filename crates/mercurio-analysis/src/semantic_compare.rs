...
use mercurio_model::{Graph, GraphError, NodeId};
...
fn element_source_file_matches(element: &mercurio_model::Element, source_file: &str) -> bool {
    element
        .properties
        .get("metadata")
        .and_then(Value::as_object)
...
fn element_start_line(element: &mercurio_model::Element) -> Option<u64> {
    element
        .properties
        .get("metadata")
        .and_then(Value::as_object)
...
fn element_name(element: &mercurio_model::Element) -> Option<String> {
    element
        .properties
        .get("declared_name")
...
fn element_type_matches(element: &mercurio_model::Element, expected: &str) -> bool {
...
mod tests {
    ...
    use mercurio_semantic_services::{WorkspaceRevision, diff_kir_documents};
