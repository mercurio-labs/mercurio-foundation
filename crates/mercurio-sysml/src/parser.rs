...
#[cfg(not(target_arch = "wasm32"))]
fn compile_timer_start() -> CompileTimer {
...
impl From<KirError> for SysmlError {
...
pub fn compile_sysml_module_with_context_report_with_limit(
    module: &SysmlModule,
    source_name: &str,
    context_modules: &[SysmlModule],
    stdlib: &KirDocument,
...
pub fn compile_sysml_module_with_resolver_context(
    module: &SysmlModule,
    source_name: &str,
    resolver_context: &ResolverContext,
    mappings: &MappingBundle,
