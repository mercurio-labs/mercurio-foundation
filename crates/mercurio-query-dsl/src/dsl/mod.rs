...
use mercurio_kir::{KirFieldKind, KirFieldRegistry};
use mercurio_model::Graph;
use mercurio_semantic_services::identity::stable_digest;
use mercurio_workspace::model_state::{ModelArtifact, ModelRevision};
...
fn insight_from_result(
    ...
    Some(SemanticInsight {
        ...
        scope: InsightScope::Revision {
            revision: mercurio_semantic_services::mutation::WorkspaceRevision {
...
mod tests {
    ...
    fn sample_revision() -> ModelRevision {
        ModelRevision::from_kir_document(
            ...
            mercurio_workspace::model_state::ModelBuildRecord::new(
                mercurio_workspace::model_state::ModelRevisionProducer::KirImport,
            ),
        )
        .unwrap()
    }
