...
use mercurio_model::{collect_specialization_ancestors, element_metatype};
...
use mercurio_session::transaction::{
...
fn graph_revision(
    graph: &Graph,
) -> Option<mercurio_semantic_services::mutation::WorkspaceRevision> {
