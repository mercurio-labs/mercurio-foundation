...
use mercurio_authoring::source_set::{
    SourceDocument, compile_source_documents, compile_source_documents_with_registry,
};
use mercurio_kir::{KIR_SCHEMA_VERSION, KirDocument, KirError};
use mercurio_model::{Edge, Element, ElementProperties, GraphArtifact};
use mercurio_runtime::{DerivedIndexes, Explanation, Fact};
use mercurio_runtime::{Runtime, RuntimeArtifact};
...
mod tests {
    ...
    use mercurio_authoring::source_set::SourceDocument;
    use mercurio_kir::{KIR_SCHEMA_VERSION, KirDocument, KirElement, KirError};
    use mercurio_runtime::Runtime;
    ...
    fn test_language_registry() -> LanguageRegistry {
        mercurio_authoring::test_support::toy_language::registry()
    }
